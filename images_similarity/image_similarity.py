...
class ImageSimilarity:
    ...
    def find_similarity_for_id(self, image_id, num_similar_images=10):
        ...
        similar_images_with_score = similar_images.join(query_results, how='inner', on={'id':'reference_label'})
        return similar_images_with_score.sort('distance', ascending=True)